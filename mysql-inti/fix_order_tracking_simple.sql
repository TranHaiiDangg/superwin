-- Fix lỗi order_tracking - File đơn giản
-- File: mysql-inti/fix_order_tracking_simple.sql

-- Bước 1: Tạo bảng customers với các trường cơ bản
...
-- Bước 3: Tạo bảng order_tracking
...
-- Bước 4: Thêm dữ liệu test cho customers
...
-- Bước 5: Thêm dữ liệu test cho orders
...
-- Bước 6: Thêm dữ liệu test cho order_tracking
