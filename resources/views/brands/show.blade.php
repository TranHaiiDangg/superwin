...
@section('title', $brand->name . ' - SuperWin')
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
            ...
            <div class="empty-state">
                ...
                <p>Thương hiệu này chưa có sản phẩm phù hợp với bộ lọc của bạn</p>
                <div class="mt-3">
                    <a href="{{ route('brands.show', $brand->id) }}" class="btn btn-primary me-2">Xem tất cả sản phẩm</a>
...
@push('styles')
<style>
/* Brand Page Styles - Extended from Category Page */
.category-sidebar {
    background: white;
    border-radius: 12px;
