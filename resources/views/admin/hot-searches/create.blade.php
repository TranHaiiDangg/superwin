...
@section('title', 'Thêm Hot Search')
@section('page-title', 'Thêm Hot Search')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Thêm Hot Search</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.hot-searches.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex space-x-3">
                            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
                                <i class="fas fa-save mr-2"></i> Tạo Hot Search
                            </button>
                            <a href="{{ route('admin.hot-searches.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg inline-flex items-center">
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                        <i class="fas fa-info-circle mr-2 text-blue-500"></i> Hướng dẫn
                    </h3>
                </div>
                <div class="p-6">
    ...
    $(document).ready(function() {
        ...
        $('form').on('submit', function() {
            console.log('=== CREATE FORM SUBMIT DEBUG ===');
            ...
            console.log('=== END CREATE FORM SUBMIT DEBUG ===');
        });
    });
    </script>
    @endsection