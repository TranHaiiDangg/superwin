...
@section('title', 'Tìm kiếm - SuperWin')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <form action="{{ route('search') }}" method="GET">
                            <div class="input-group">
                                <input type="text" class="form-control" name="q" value="{{ $query }}" placeholder="Tìm sản phẩm...">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="{{ route('search', ['q' => $query, 'category' => $category->slug]) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="{{ route('search', ['q' => $query, 'brand' => $brand->slug]) }}" 
                               class="list-group-item list-group-item-action">
                                {{ $brand->name }}
                            </a>
                            @endforeach
        ...
        <div class="col-lg-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-1">Kết quả tìm kiếm</h4>
                    <p class="text-muted mb-0">Từ khóa: "{{ $query }}" - {{ $products->total() }} kết quả</p>
                </div>
            </div>
